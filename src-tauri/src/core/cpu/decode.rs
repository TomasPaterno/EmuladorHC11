...
fn page_0(pc: u16, op: u8) -> Result<Decoded, CoreError> {
    let row = match op {
        ...
        0x04 => ("LSRD", Op::Lsrd, Mode::Inh, 1, 3),
        0x05 => ("ASLD", Op::Asld, Mode::Inh, 1, 3),
        ...
        0x60 => ("NEG", Op::NegMem(Mode::IndX), Mode::IndX, 2, 6),
        0x63 => ("COM", Op::ComMem(Mode::IndX), Mode::IndX, 2, 6),
        0x64 => ("LSR", Op::LsrMem(Mode::IndX), Mode::IndX, 2, 6),
        0x66 => ("ROR", Op::RorMem(Mode::IndX), Mode::IndX, 2, 6),
        0x67 => ("ASR", Op::AsrMem(Mode::IndX), Mode::IndX, 2, 6),
        0x68 => ("ASL", Op::AslMem(Mode::IndX), Mode::IndX, 2, 6),
        0x69 => ("ROL", Op::RolMem(Mode::IndX), Mode::IndX, 2, 6),
        0x6A => ("DEC", Op::DecMem(Mode::IndX), Mode::IndX, 2, 6),
        0x6C => ("INC", Op::IncMem(Mode::IndX), Mode::IndX, 2, 6),
        0x6D => ("TST", Op::TstMem(Mode::IndX), Mode::IndX, 2, 6),
        0x6E => ("JMP", Op::Jmp(Mode::IndX), Mode::IndX, 2, 3),
        0x6F => ("CLR", Op::ClrMem(Mode::IndX), Mode::IndX, 2, 6),
        0x70 => ("NEG", Op::NegMem(Mode::Ext), Mode::Ext, 3, 6),
        0x73 => ("COM", Op::ComMem(Mode::Ext), Mode::Ext, 3, 6),
        0x74 => ("LSR", Op::LsrMem(Mode::Ext), Mode::Ext, 3, 6),
        0x76 => ("ROR", Op::RorMem(Mode::Ext), Mode::Ext, 3, 6),
        0x77 => ("ASR", Op::AsrMem(Mode::Ext), Mode::Ext, 3, 6),
        0x78 => ("ASL", Op::AslMem(Mode::Ext), Mode::Ext, 3, 6),
        0x79 => ("ROL", Op::RolMem(Mode::Ext), Mode::Ext, 3, 6),
        0x7A => ("DEC", Op::DecMem(Mode::Ext), Mode::Ext, 3, 6),
        0x7C => ("INC", Op::IncMem(Mode::Ext), Mode::Ext, 3, 6),
        0x7D => ("TST", Op::TstMem(Mode::Ext), Mode::Ext, 3, 6),
        ...
        0x83 => ("SUBD", Op::Sub16(Mode::Imm16), Mode::Imm16, 3, 4),
        ...
        0x8C => ("CPX", Op::Cmp16(WordReg::X, Mode::Imm16), Mode::Imm16, 3, 4),
        ...
        0x91 => ("CMPA", Op::Cmp8(Acc::A, Mode::Dir), Mode::Dir, 2, 3),
        0x93 => ("SUBD", Op::Sub16(Mode::Dir), Mode::Dir, 2, 5),
        0x94 => ("ANDA", Op::And8(Acc::A, Mode::Dir), Mode::Dir, 2, 3),
        0x95 => ("BITA", Op::Bit8(Acc::A, Mode::Dir), Mode::Dir, 2, 3),
        0x96 => ("LDAA", Op::Ld8(Acc::A, Mode::Dir), Mode::Dir, 2, 3),
        0x97 => ("STAA", Op::St8(Acc::A, Mode::Dir), Mode::Dir, 2, 3),
        0x98 => ("EORA", Op::Eor8(Acc::A, Mode::Dir), Mode::Dir, 2, 3),
        0x99 => ("ADCA", Op::AddC8(Acc::A, Mode::Dir), Mode::Dir, 2, 3),
        0x9A => ("ORAA", Op::Ora8(Acc::A, Mode::Dir), Mode::Dir, 2, 3),
        0x9B => ("ADDA", Op::Add8(Acc::A, Mode::Dir), Mode::Dir, 2, 3),
        0x9C => ("CPX", Op::Cmp16(WordReg::X, Mode::Dir), Mode::Dir, 2, 5),
        ...
        0xA0 => ("SUBA", Op::Sub8(Acc::A, Mode::IndX), Mode::IndX, 2, 4),
        0xA1 => ("CMPA", Op::Cmp8(Acc::A, Mode::IndX), Mode::IndX, 2, 4),
        0xA3 => ("SUBD", Op::Sub16(Mode::IndX), Mode::IndX, 2, 6),
        0xA4 => ("ANDA", Op::And8(Acc::A, Mode::IndX), Mode::IndX, 2, 4),
        0xA5 => ("BITA", Op::Bit8(Acc::A, Mode::IndX), Mode::IndX, 2, 4),
        0xA6 => ("LDAA", Op::Ld8(Acc::A, Mode::IndX), Mode::IndX, 2, 4),
        0xA7 => ("STAA", Op::St8(Acc::A, Mode::IndX), Mode::IndX, 2, 4),
        0xA8 => ("EORA", Op::Eor8(Acc::A, Mode::IndX), Mode::IndX, 2, 4),
        0xA9 => ("ADCA", Op::AddC8(Acc::A, Mode::IndX), Mode::IndX, 2, 4),
        0xAA => ("ORAA", Op::Ora8(Acc::A, Mode::IndX), Mode::IndX, 2, 4),
        0xAB => ("ADDA", Op::Add8(Acc::A, Mode::IndX), Mode::IndX, 2, 4),
        0xAC => ("CPX", Op::Cmp16(WordReg::X, Mode::IndX), Mode::IndX, 2, 6),
        ...
        0xB0 => ("SUBA", Op::Sub8(Acc::A, Mode::Ext), Mode::Ext, 3, 4),
        0xB1 => ("CMPA", Op::Cmp8(Acc::A, Mode::Ext), Mode::Ext, 3, 4),
        0xB3 => ("SUBD", Op::Sub16(Mode::Ext), Mode::Ext, 3, 6),
        0xB4 => ("ANDA", Op::And8(Acc::A, Mode::Ext), Mode::Ext, 3, 4),
        0xB5 => ("BITA", Op::Bit8(Acc::A, Mode::Ext), Mode::Ext, 3, 4),
        0xB6 => ("LDAA", Op::Ld8(Acc::A, Mode::Ext), Mode::Ext, 3, 4),
        0xB7 => ("STAA", Op::St8(Acc::A, Mode::Ext), Mode::Ext, 3, 4),
        0xB8 => ("EORA", Op::Eor8(Acc::A, Mode::Ext), Mode::Ext, 3, 4),
        0xB9 => ("ADCA", Op::AddC8(Acc::A, Mode::Ext), Mode::Ext, 3, 4),
        0xBA => ("ORAA", Op::Ora8(Acc::A, Mode::Ext), Mode::Ext, 3, 4),
        0xBB => ("ADDA", Op::Add8(Acc::A, Mode::Ext), Mode::Ext, 3, 4),
        0xBC => ("CPX", Op::Cmp16(WordReg::X, Mode::Ext), Mode::Ext, 3, 6),
        ...
        0xC1 => ("CMPB", Op::Cmp8(Acc::B, Mode::Imm), Mode::Imm, 2, 2),
        0xC3 => ("ADDD", Op::Add16(Mode::Imm16), Mode::Imm16, 3, 4),
        0xC4 => ("ANDB", Op::And8(Acc::B, Mode::Imm), Mode::Imm, 2, 2),
        0xC5 => ("BITB", Op::Bit8(Acc::B, Mode::Imm), Mode::Imm, 2, 2),
        0xC6 => ("LDAB", Op::Ld8(Acc::B, Mode::Imm), Mode::Imm, 2, 2),
        0xC8 => ("EORB", Op::Eor8(Acc::B, Mode::Imm), Mode::Imm, 2, 2),
        0xC9 => ("ADCB", Op::AddC8(Acc::B, Mode::Imm), Mode::Imm, 2, 2),
        0xCA => ("ORAB", Op::Ora8(Acc::B, Mode::Imm), Mode::Imm, 2, 2),
        ...
        0xD0 => ("SUBB", Op::Sub8(Acc::B, Mode::Dir), Mode::Dir, 2, 3),
        0xD1 => ("CMPB", Op::Cmp8(Acc::B, Mode::Dir), Mode::Dir, 2, 3),
        0xD3 => ("ADDD", Op::Add16(Mode::Dir), Mode::Dir, 2, 5),
        0xD4 => ("ANDB", Op::And8(Acc::B, Mode::Dir), Mode::Dir, 2, 3),
        0xD5 => ("BITB", Op::Bit8(Acc::B, Mode::Dir), Mode::Dir, 2, 3),
        0xD6 => ("LDAB", Op::Ld8(Acc::B, Mode::Dir), Mode::Dir, 2, 3),
        0xD7 => ("STAB", Op::St8(Acc::B, Mode::Dir), Mode::Dir, 2, 3),
        0xD8 => ("EORB", Op::Eor8(Acc::B, Mode::Dir), Mode::Dir, 2, 3),
        0xD9 => ("ADCB", Op::AddC8(Acc::B, Mode::Dir), Mode::Dir, 2, 3),
        0xDA => ("ORAB", Op::Ora8(Acc::B, Mode::Dir), Mode::Dir, 2, 3),
        0xDB => ("ADDB", Op::Add8(Acc::B, Mode::Dir), Mode::Dir, 2, 3),
        ...
        0xE0 => ("SUBB", Op::Sub8(Acc::B, Mode::IndX), Mode::IndX, 2, 4),
        0xE1 => ("CMPB", Op::Cmp8(Acc::B, Mode::IndX), Mode::IndX, 2, 4),
        0xE3 => ("ADDD", Op::Add16(Mode::IndX), Mode::IndX, 2, 6),
        0xE4 => ("ANDB", Op::And8(Acc::B, Mode::IndX), Mode::IndX, 2, 4),
        0xE5 => ("BITB", Op::Bit8(Acc::B, Mode::IndX), Mode::IndX, 2, 4),
        0xE6 => ("LDAB", Op::Ld8(Acc::B, Mode::IndX), Mode::IndX, 2, 4),
        0xE7 => ("STAB", Op::St8(Acc::B, Mode::IndX), Mode::IndX, 2, 4),
        0xE8 => ("EORB", Op::Eor8(Acc::B, Mode::IndX), Mode::IndX, 2, 4),
        0xE9 => ("ADCB", Op::AddC8(Acc::B, Mode::IndX), Mode::IndX, 2, 4),
        0xEA => ("ORAB", Op::Ora8(Acc::B, Mode::IndX), Mode::IndX, 2, 4),
        0xEB => ("ADDB", Op::Add8(Acc::B, Mode::IndX), Mode::IndX, 2, 4),
        0xEC => ("LDD", Op::Ld16(WordReg::D, Mode::IndX), Mode::IndX, 2, 5),
        0xED => ("STD", Op::St16(WordReg::D, Mode::IndX), Mode::IndX, 2, 5),
        0xEE => ("LDX", Op::Ld16(WordReg::X, Mode::IndX), Mode::IndX, 2, 5),
        0xEF => ("STX", Op::St16(WordReg::X, Mode::IndX), Mode::IndX, 2, 5),
        0xF0 => ("SUBB", Op::Sub8(Acc::B, Mode::Ext), Mode::Ext, 3, 4),
        0xF1 => ("CMPB", Op::Cmp8(Acc::B, Mode::Ext), Mode::Ext, 3, 4),
        0xF3 => ("ADDD", Op::Add16(Mode::Ext), Mode::Ext, 3, 6),
        0xF4 => ("ANDB", Op::And8(Acc::B, Mode::Ext), Mode::Ext, 3, 4),
        0xF5 => ("BITB", Op::Bit8(Acc::B, Mode::Ext), Mode::Ext, 3, 4),
        0xF6 => ("LDAB", Op::Ld8(Acc::B, Mode::Ext), Mode::Ext, 3, 4),
        0xF7 => ("STAB", Op::St8(Acc::B, Mode::Ext), Mode::Ext, 3, 4),
        0xF8 => ("EORB", Op::Eor8(Acc::B, Mode::Ext), Mode::Ext, 3, 4),
        0xF9 => ("ADCB", Op::AddC8(Acc::B, Mode::Ext), Mode::Ext, 3, 4),
        0xFA => ("ORAB", Op::Ora8(Acc::B, Mode::Ext), Mode::Ext, 3, 4),
        0xFB => ("ADDB", Op::Add8(Acc::B, Mode::Ext), Mode::Ext, 3, 4),
        0xFC => ("LDD", Op::Ld16(WordReg::D, Mode::Ext), Mode::Ext, 3, 5),
        0xFD => ("STD", Op::St16(WordReg::D, Mode::Ext), Mode::Ext, 3, 5),
        0xFE => ("LDX", Op::Ld16(WordReg::X, Mode::Ext), Mode::Ext, 3, 5),
        0xFF => ("STX", Op::St16(WordReg::X, Mode::Ext), Mode::Ext, 3, 5),
...
fn page_18(pc: u16, op: u8) -> Result<Decoded, CoreError> {
    let row = match op {
        ...
        0x3A => ("ABY", Op::Aby, Mode::Inh, 2, 4),
        0x3C => ("PSHY", Op::Pshy, Mode::Inh, 2, 5),
        0x60 => ("NEG", Op::NegMem(Mode::IndY), Mode::IndY, 3, 7),
        0x63 => ("COM", Op::ComMem(Mode::IndY), Mode::IndY, 3, 7),
        0x64 => ("LSR", Op::LsrMem(Mode::IndY), Mode::IndY, 3, 7),
        0x66 => ("ROR", Op::RorMem(Mode::IndY), Mode::IndY, 3, 7),
        0x67 => ("ASR", Op::AsrMem(Mode::IndY), Mode::IndY, 3, 7),
        0x68 => ("ASL", Op::AslMem(Mode::IndY), Mode::IndY, 3, 7),
        0x69 => ("ROL", Op::RolMem(Mode::IndY), Mode::IndY, 3, 7),
        0x6A => ("DEC", Op::DecMem(Mode::IndY), Mode::IndY, 3, 7),
        0x6C => ("INC", Op::IncMem(Mode::IndY), Mode::IndY, 3, 7),
        0x6D => ("TST", Op::TstMem(Mode::IndY), Mode::IndY, 3, 7),
        0x6E => ("JMP", Op::Jmp(Mode::IndY), Mode::IndY, 3, 4),
        0x6F => ("CLR", Op::ClrMem(Mode::IndY), Mode::IndY, 3, 7),
        0x8C => ("CPY", Op::Cmp16(WordReg::Y, Mode::Imm16), Mode::Imm16, 4, 5),
        0x8F => ("XGDY", Op::Xgdy, Mode::Inh, 2, 4),
        0x9C => ("CPY", Op::Cmp16(WordReg::Y, Mode::Dir), Mode::Dir, 3, 6),
        0xA0 => ("SUBA", Op::Sub8(Acc::A, Mode::IndY), Mode::IndY, 3, 5),
        0xA1 => ("CMPA", Op::Cmp8(Acc::A, Mode::IndY), Mode::IndY, 3, 5),
        0xA3 => ("SUBD", Op::Sub16(Mode::IndY), Mode::IndY, 3, 7),
        ...
        0xAC => ("CPY", Op::Cmp16(WordReg::Y, Mode::IndY), Mode::IndY, 3, 7),
        ...
        0xBC => ("CPY", Op::Cmp16(WordReg::Y, Mode::Ext), Mode::Ext, 4, 7),
        ...
        0xE1 => ("CMPB", Op::Cmp8(Acc::B, Mode::IndY), Mode::IndY, 3, 5),
        0xE3 => ("ADDD", Op::Add16(Mode::IndY), Mode::IndY, 3, 7),
        0xE4 => ("ANDB", Op::And8(Acc::B, Mode::IndY), Mode::IndY, 3, 5),
        0xE5 => ("BITB", Op::Bit8(Acc::B, Mode::IndY), Mode::IndY, 3, 5),
        0xE6 => ("LDAB", Op::Ld8(Acc::B, Mode::IndY), Mode::IndY, 3, 5),
        0xE7 => ("STAB", Op::St8(Acc::B, Mode::IndY), Mode::IndY, 3, 5),
        0xE8 => ("EORB", Op::Eor8(Acc::B, Mode::IndY), Mode::IndY, 3, 5),
        0xE9 => ("ADCB", Op::AddC8(Acc::B, Mode::IndY), Mode::IndY, 3, 5),
        0xEA => ("ORAB", Op::Ora8(Acc::B, Mode::IndY), Mode::IndY, 3, 5),
...
fn page_1a(pc: u16, op: u8) -> Result<Decoded, CoreError> {
    let row = match op {
        0x83 => ("CPD", Op::Cmp16(WordReg::D, Mode::Imm16), Mode::Imm16, 4, 5),
        0x93 => ("CPD", Op::Cmp16(WordReg::D, Mode::Dir), Mode::Dir, 3, 6),
        0xA3 => ("CPD", Op::Cmp16(WordReg::D, Mode::IndX), Mode::IndX, 3, 7),
        0xAC => ("CPY", Op::Cmp16(WordReg::Y, Mode::IndX), Mode::IndX, 3, 7),
        0xB3 => ("CPD", Op::Cmp16(WordReg::D, Mode::Ext), Mode::Ext, 4, 7),
...
fn page_cd(pc: u16, op: u8) -> Result<Decoded, CoreError> {
    let row = match op {
        0xA3 => ("CPD", Op::Cmp16(WordReg::D, Mode::IndY), Mode::IndY, 3, 7),
        0xAC => ("CPX", Op::Cmp16(WordReg::X, Mode::IndY), Mode::IndY, 3, 7),
...
mod tests {
    ...
    #[test]
    fn implemented_inventory_matches_page_walk() {
        let mut bus = Bus::new_e9();
        let mut count = 0;
        for opcode in 0u8..=255 {
        ...
        assert_eq!(count, super::implemented_rows().len());
    }

    #[test]
    fn prefixes_without_verified_row_stay_unimplemented() {
        let bus_1a = bus_with(&[0x1A, 0x00]);
        assert!(matches!(
            decode(&bus_1a, 0),
